...
import styles from "./IconAccessory.module.css";
// Figma SSOT: SKT-Next_UI-Draft_3.3 .IconItem/Nomal/Accessory (node 51561:33520)
...
export function IconAccessory({ size = 24, color = "currentColor", className }: Props) {
  const rootClass = [styles.root, className].filter(Boolean).join(" ");
  return (
    <svg
      data-cx-component="IconAccessory"
      className={rootClass}
      width={size}
      height={size}
      viewBox="0 0 24 24"
