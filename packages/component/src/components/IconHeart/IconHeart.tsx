...
// Figma SSOT: SKT-Next_UI-Draft_3.3 .IconItem/Nomal/Heart (node 51578:64730)
...
export function IconHeart({ size = 24, color = "currentColor", className, variant = "line" }: Props) {
